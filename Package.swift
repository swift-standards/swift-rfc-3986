...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/swift-standards/swift-ipv4-standard", from: "0.1.2"),
        .package(url: "https://github.com/swift-standards/swift-ipv6-standard", from: "0.1.2"),
    ],
    targets: [
        .target(
            name: "RFC 3986",
